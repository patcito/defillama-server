...
export default async function getTokenPrices(
  ...
  const [
    ...
    knownTokenIsGas ?
      getBalance({ target: pool, block, chain, }) : null,
    call({ target: unknownToken, params: pool, abi: "erc20:balanceOf", block, chain, }),
    knownTokenIsGas ? null : call({ target: knownToken, params: pool, abi: "erc20:balanceOf", block, chain, }),
    call({ target: unknownToken, abi: "erc20:decimals", block, chain, }),
    call({ target: knownToken, abi: "erc20:decimals", block, chain, }),
